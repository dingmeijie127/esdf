...
if(fast_planner_sdf_map_CONFIG_INCLUDED)
  return()
endif()
set(fast_planner_sdf_map_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(fast_planner_sdf_map_SOURCE_PREFIX /home/dmj/study/esdf_ws/src/fast_planner_sdf_map)
  set(fast_planner_sdf_map_DEVEL_PREFIX /home/dmj/study/esdf_ws/devel)
  set(fast_planner_sdf_map_INSTALL_PREFIX "")
  set(fast_planner_sdf_map_PREFIX ${fast_planner_sdf_map_DEVEL_PREFIX})
else()
  set(fast_planner_sdf_map_SOURCE_PREFIX "")
  set(fast_planner_sdf_map_DEVEL_PREFIX "")
  set(fast_planner_sdf_map_INSTALL_PREFIX /home/dmj/study/esdf_ws/install)
  set(fast_planner_sdf_map_PREFIX ${fast_planner_sdf_map_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'fast_planner_sdf_map' is deprecated")
...
set(fast_planner_sdf_map_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/dmj/study/esdf_ws/src/fast_planner_sdf_map/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(fast_planner_sdf_map_INCLUDE_DIRS "")
  set(_include_dirs "/home/dmj/study/esdf_ws/src/fast_planner_sdf_map/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND fast_planner_sdf_map_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dmj/study/esdf_ws/devel/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(fast_planner_sdf_map_LIBRARY_DIRS ${lib_path})
      list(APPEND fast_planner_sdf_map_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'fast_planner_sdf_map'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND fast_planner_sdf_map_LIBRARIES ${lib})
    endif()
  endif()
...
set(fast_planner_sdf_map_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${fast_planner_sdf_map_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;std_msgs;sensor_msgs;geometry_msgs;pcl_ros;cv_bridge;image_transport;message_filters")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 fast_planner_sdf_map_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${fast_planner_sdf_map_dep}_FOUND)
      find_package(${fast_planner_sdf_map_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fast_planner_sdf_map_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(fast_planner_sdf_map_INCLUDE_DIRS ${${fast_planner_sdf_map_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(fast_planner_sdf_map_LIBRARIES ${fast_planner_sdf_map_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${fast_planner_sdf_map_dep}_LIBRARIES})
  _list_append_deduplicate(fast_planner_sdf_map_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(fast_planner_sdf_map_LIBRARIES ${fast_planner_sdf_map_LIBRARIES})

  _list_append_unique(fast_planner_sdf_map_LIBRARY_DIRS ${${fast_planner_sdf_map_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(fast_planner_sdf_map_EXPORTED_TARGETS ${${fast_planner_sdf_map_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${fast_planner_sdf_map_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
